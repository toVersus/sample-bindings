...
import (
	...
	externalversions "github.com/toversus/sample-bindings/pkg/client/informers/externalversions"
	client "github.com/toversus/sample-bindings/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/toversus/sample-bindings/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
