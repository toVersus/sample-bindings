...
import (
	...
	"github.com/toversus/sample-bindings/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type BindingsV1alpha1Interface interface {
	RESTClient() rest.Interface
	DatabaseBindingsGetter
}

// BindingsV1alpha1Client is used to interact with features provided by the bindings.toversus.dev group.
type BindingsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *BindingsV1alpha1Client) DatabaseBindings(namespace string) DatabaseBindingInterface {
	return newDatabaseBindings(c, namespace)
}
